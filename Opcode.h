...
class OpcodeTable {
 public:
  ...
  //given a binary string this will return the opcode
	Opcode findOpcode(string str);

	Opcode findRtypeOpcode(string function);

  string getOp(Opcode o); //returns the mips name of the operation
