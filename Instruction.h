...
class Instruction{
 public:
  ...
  Instruction(Opcode op, Register rs, Register rt, Register rd, int imm, string address);
  ~Instruction() {};
  ...
  void setValues(Opcode op, Register rs, Register rt, Register rd, int imm, string address);
  ...
  void setEncoding(string s) { //cout << "setting encoding: " << s << endl;
	myEncoding = s;};
	void setDecoding(string s);
